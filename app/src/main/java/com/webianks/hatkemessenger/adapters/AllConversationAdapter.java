...
//        if (data.get(3).getReadState().equals("0")){

          view = inflater.inflate(R.layout.single_sms_small_layout, parent, false);
...
//        else {
//
//            view = inflater.inflate(R.layout.unread_layout_item, parent, false);
//
//
//        }
