    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id)
                {
                    case R.id.all_conversations:
                        Intent intent=new Intent(MainActivity.this,MainActivity.class);
                        startActivity(intent);

                    case R.id.settings:
                        Intent intentg=new Intent(MainActivity.this,SettingsActivity.class);
                        startActivity(intentg);
//                    default:


                        // Toast.makeText(Main_Activity.this, "Settings",Toast.LENGTH_SHORT).show();break;
//                    case R.id.about_us:
//                        Intent intent1=new Intent(Main_Activity.this,Scheduled_Messages_Preview_Activity.class);
//                        startActivity(intent1);
////                        Intent intent4=new Intent(Main_Activity.this,Passcode_Before_goto_Private_Conversations.class);
////                        startActivity(intent4);
//                         break;
//                    case R.id.unread_conversation:
//                        Intent intenta=new Intent(Main_Activity.this,Private_Conversations_Preview_Activity.class);
//                        startActivity(intenta);
//                        break;
//
//                    case R.id.sceduled_messages:
//                        Intent intentgg=new Intent(Main_Activity.this,Create_New_Scheduled_Messages.class);
//                        startActivity(intentgg);
//
//                        break;
//                    case R.id.archive_conversation:
//                        Intent intentgh=new Intent(Main_Activity.this,Unread_Conversations_Activity.class);
//                        startActivity(intentgh);
//                        break;
//
//
//                    case R.id.about_us:
//                        Intent intent2=new Intent(Main_Activity.this,More_Rate_Share_Activities.class);
//                        startActivity(intent2);
//                        Toast.makeText(Main_Activity.this, "My Cart",Toast.LENGTH_SHORT).show();break;
//
                }
                return true;
            }
    ...
    private void init() {
        ...
        recyclerView = findViewById(R.id.main_message_recycler_view);
        fab = findViewById(R.id.floating_button_layout_main_messsage);
...
//        fab.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.floating_button_layout_main_messsage:
